  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] px-6 py-24 text-zinc-800 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-5xl">
        <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Астана</p>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-zinc-900">Материалы</h2>
          ...
          <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-zinc-900">Цены</h2>
            <p className="mt-3 text-sm leading-7 text-zinc-600">
          ...
          <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-zinc-900">Сроки</h2>
            <p className="mt-3 text-sm leading-7 text-zinc-600">
        ...
        <div className="mt-8 rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <h2 className="text-2xl font-semibold text-zinc-900">Бесплатный выезд инженера</h2>
              <p className="mt-3 text-sm leading-7 text-zinc-600">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <Link href="/tseny" className="text-sm font-medium text-orange-500">Цены →</Link>
          <Link href="/materialy" className="text-sm font-medium text-orange-500">Материалы →</Link>
          <Link href="/uslugi" className="text-sm font-medium text-orange-500">Услуги →</Link>
        </div>
      </div>
    </main>
  );
