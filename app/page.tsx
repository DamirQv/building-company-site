...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] text-zinc-800">
      ...
      {/* Блок 1 — Первый экран */}
      <section className="relative isolate overflow-hidden bg-[url('/hero.jpg')] bg-cover bg-center">
        <div className="absolute inset-0 bg-gradient-to-r from-zinc-900/95 via-zinc-900/80 to-zinc-900/65" />
          ...
          <div className="grid items-end gap-10 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:py-28">
            <div className="max-w-3xl">
              <div className="mb-5 flex flex-wrap items-center gap-3">
                <span className="rounded-full border border-orange-400/30 bg-orange-500/10 px-3 py-1 text-sm font-medium text-orange-300">
                  Standard Stroy
                </span>
                <span className="rounded-full border border-white/15 bg-white/10 px-3 py-1 text-sm text-zinc-200">
              ...
              <ul className="mt-6 grid gap-2 sm:grid-cols-2">
                {heroBullets.map((bullet) => (
                  <li key={bullet} className="flex items-center gap-2 text-sm text-zinc-200">
                    <span className="text-orange-400">✓</span> {bullet}
                  </li>
                ))}
              </ul>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  href="#quiz"
                  className="rounded-full bg-orange-500 px-7 py-3 font-medium text-white transition hover:bg-orange-600"
                >
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/10 p-8 backdrop-blur">
              <p className="text-sm uppercase tracking-[0.3em] text-zinc-300">Что вы получаете</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="grid gap-8 rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm md:grid-cols-3">
          {stats.map((item) => (
            <div key={item.label} className="text-center">
              <div className="text-4xl font-semibold text-orange-500 sm:text-5xl">{item.value}</div>
              <div className="mt-2 text-sm uppercase tracking-[0.25em] text-zinc-500">{item.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="quiz" className="mx-auto max-w-7xl scroll-mt-20 px-6 py-6 sm:px-8 lg:px-12">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Квиз-калькулятор</p>
            <h2 className="mt-2 text-3xl font-semibold sm:text-4xl">Рассчитайте стоимость дома за 1 минуту</h2>
          </div>
          <div className="text-sm text-zinc-500">Быстро • Точно • Без переплат</div>
        </div>
        <LeadQuiz />
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="mb-10">
          <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Главный блок доверия</p>
        ...
        <div className="mt-6 rounded-[2rem] border border-zinc-200 bg-zinc-50 p-6 text-sm text-zinc-600">
      ...
      <section className="mx-auto max-w-7xl px-6 py-6 sm:px-8 lg:px-12">
        <div className="grid gap-8 rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm lg:grid-cols-2">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Онлайн-камера</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="mb-10">
          <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Этапы работ</p>
        ...
        <div className="mt-8">
          <Link
            ...
            className="inline-flex rounded-full bg-orange-500 px-6 py-3 text-sm font-medium text-white transition hover:bg-orange-600"
          >
            Начать с проекта
          </Link>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-6 sm:px-8 lg:px-12">
        <div className="mb-10">
          <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Построенные объекты</p>
        ...
        <div className="mt-8">
          <Link href="/obekty" className="text-sm font-medium text-orange-500">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        ...
        <div className="mt-8">
          <Link href="/otzyvy" className="text-sm font-medium text-orange-500">
            Все отзывы →
          </Link>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-6 sm:px-8 lg:px-12">
        <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-200 text-left">
                  <th className="py-3 pr-4 font-medium text-zinc-500">Параметр</th>
                  <th className="py-3 px-4 font-semibold text-zinc-900">FinnBlock</th>
                  <th className="py-3 px-4 font-semibold text-zinc-900">Газоблок</th>
                  <th className="py-3 px-4 font-semibold text-zinc-900">Кирпич</th>
                </tr>
              </thead>
              <tbody>
                {materialsComparison.map((row) => (
                  <tr key={row.feature} className="border-b border-zinc-100">
                    <td className="py-3 pr-4 text-zinc-500">{row.feature}</td>
                    <td className="py-3 px-4 text-zinc-800">{row.finnblock}</td>
                    <td className="py-3 px-4 text-zinc-800">{row.gazoblock}</td>
                    <td className="py-3 px-4 text-zinc-800">{row.kirpich}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/materialy/doma-iz-finnblock" className="text-sm font-medium text-orange-500">Дома из FinnBlock →</Link>
            <Link href="/materialy/doma-iz-gazobloka" className="text-sm font-medium text-orange-500">Дома из газоблока →</Link>
            <Link href="/materialy/doma-iz-kirpicha" className="text-sm font-medium text-orange-500">Дома из кирпича →</Link>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="mb-10">
          <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Как мы работаем</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-6 sm:px-8 lg:px-12">
        <div className="mb-10">
          <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Команда</p>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {team.map((member) => (
            <div key={member.role} className="rounded-[2rem] border border-zinc-200 bg-white p-6 text-center shadow-sm">
              <div className="mx-auto h-24 w-24 overflow-hidden rounded-full bg-zinc-100">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 lg:p-10 shadow-sm">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Документы</p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {documents.map((doc) => (
                <div key={doc.title} className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                  <p className="text-sm font-medium text-zinc-900">{doc.title}</p>
                  <p className="mt-1 text-xs text-zinc-500">{doc.note}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-6 sm:px-8 lg:px-12">
        <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm">
          <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Наши отличия</p>
          <h2 className="mt-2 text-3xl font-semibold sm:text-4xl">Что делает нас разными</h2>
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {companyBenefits.map((benefit) => (
              <div key={benefit.title} className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 lg:p-10 shadow-sm">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Оставить заявку</p>
