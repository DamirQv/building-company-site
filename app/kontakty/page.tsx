      ...
      <section className="mx-auto max-w-5xl px-6 py-16 sm:px-8 lg:px-12">
        <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-sm">
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Контакты</p>
              ...
              <div className="mt-10 grid gap-4 text-sm text-zinc-700 sm:grid-cols-2">
                <div className="rounded-3xl bg-zinc-50 p-6">
                  <p className="font-semibold text-zinc-900">Телефон</p>
              ...
              <div className="mt-10 rounded-3xl border border-orange-200 bg-orange-50 p-6 text-sm text-zinc-800">
                ...
                <Link
                  href="/#quiz"
                  className="mt-4 inline-flex rounded-full bg-orange-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-orange-600"
                >
            ...
            <div className="rounded-[2rem] border border-zinc-200 bg-zinc-50 p-8 shadow-sm">
              <div className="mb-6">
                <p className="text-sm uppercase tracking-[0.3em] text-orange-500">Форма заявки</p>
                <h2 className="mt-3 text-3xl font-semibold text-zinc-900">Получите консультацию прямо здесь</h2>
              </div>
